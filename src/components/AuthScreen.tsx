        ...
        <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
          ...
          <div>
            ...
            <div className="relative group">
                ...
                <input type="text" required value={username} onChange={(e) => setUsername(e.target.value)} placeholder="Votre identifiant" className="w-full bg-slate-50 dark:bg-slate-800/50 text-slate-800 dark:text-white rounded-2xl pl-12 pr-4 py-4 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 dark:focus:border-indigo-400 transition-all border border-slate-200 dark:border-slate-700 font-medium placeholder:text-slate-400 text-sm" />
            </div>
          </div>
